 ...
 *
 * The Fastify API is the data source (replacing Blink). Set the origin with
 * VITE_API_URL (default: the local server on :4000). When the frontend and API
 * share an origin in production, set VITE_API_URL='' so URLs stay relative.
 *
